       ...
       <div class="block">
        <div style="margin-top: -10px; width: 100%; height: 224px; border-radius: 8px;  background-size: 100%;
          ...
          <i class="white-color f7-icons">arrow_left</i> Back  </a>
            ...
            <center>
  <img src="./img/bully.png"  class="appicon elevation-5 animated zoomIn shadow" style="border-radius: 25%; height: 100px;width: 100px;">
  <div style="font-size: 22px" class="white-color semibold">Bully</div>
