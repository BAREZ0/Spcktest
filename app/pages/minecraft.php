  ...
  <div style="font-size: 16px; opacity: 0,57;" class="white-color semibold">Games</div>
        ...
        Download App
                           ...
                           <div class="item-title-row block block-strong inset elevation-12" style="justify-content: flex-end;">
                            <a href="itms-services://?action=download-manifest&amp;url=https://www.seeyouios.store/plist/minecraft.plist" class="button button-round button-fill button-raised color-green external"> ㅤGet <i class="icon f7-icons color-white">cloud_download_fill</i></a>
<br>
